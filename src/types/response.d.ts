...
export type Relationship = ArtistRelationship | AuthorRelationship | CoverRelationship | ChapterFeedRelationship | MangaRelationship;
...
export interface ResponseChapter extends ResponseBase<"ok"> {
  baseUrl: string
...
export type ResponseChapterFeed = ResponseCollection<ChapterFeedData>
